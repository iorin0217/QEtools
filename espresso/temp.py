...
atomic_configs_dict = {
    'H':  ( '', [ '1s1' ], 1, 'Hydrogen' ),
    'He': ( '', [ '1s2' ], 2, 'Helium' ),
    'Li': ( '', [ '1s2', '2s1' ], 3, 'Lithium' ),
    'Be': ( '', [ '1s2', '2s2' ], 4, 'Beryllium' ),
    'B':  ( '', [ '1s2', '2s2', '2p1' ], 5, 'Boron' ),
    ...
    'Rb': ( 'Kr', [ '5s1' ], 37, 'Rubidium' ),
    'Sr': ( 'Kr', [ '5s2' ], 38, 'Strontium' ),
    'Y':  ( 'Kr', [ '4d1', '5s2' ], 39, 'Yttrium' ),
    'Zr': ( 'Kr', [ '4d2', '5s2' ], 40, 'Zirconium' ),
    'Nb': ( 'Kr', [ '4d4', '5s1' ], 41, 'Niobium' ),
    'Mo': ( 'Kr', [ '4d5', '5s1' ], 42, 'Molybdenum' ),
    'Tc': ( 'Kr', [ '4d5', '5s2' ], 43, 'Technetium' ),
    'Ru': ( 'Kr', [ '4d7', '5s1' ], 44, 'Ruthenium' ),
    'Rh': ( 'Kr', [ '4d8', '5s1' ], 45, 'Rhodium' ),
    'Pd': ( 'Kr', [ '4d10' ], 46, 'Palladium' ),
    'Ag': ( 'Kr', [ '4d10', '5s1' ], 47, 'Silver' ),
    'Cd': ( 'Kr', [ '4d10', '5s2' ], 48, 'Cadmium' ),
    'In': ( 'Kr', [ '4d10', '5s2', '5p1' ], 49, 'Indium' ),
    ...
    'Cs': ( 'Xe', [ '6s1' ], 55, 'Cesium' ),
    'Ba': ( 'Xe', [ '6s2' ], 56, 'Barium' ),
    'La': ( 'Xe', [ '5d1', '6s2' ], 57, 'Lanthanum' ),
    'Ce': ( 'Xe', [ '4f1', '5d1', '6s2' ], 58, 'Cerium' ),
    ...
    'Gd': ( 'Xe', [ '4f7', '5d1', '6s2' ], 64, 'Gadolinium' ),
    ...
    'Pt': ( 'Xe', [ '4f14', '5d9', '6s1' ], 78, 'Platinum' ),
    'Au': ( 'Xe', [ '4f14', '5d10', '6s1' ], 79, 'Gold' ),
    'Hg': ( 'Xe', [ '4f14', '5d10', '6s2' ], 80, 'Mercury' ),
    'Tl': ( 'Xe', [ '4f14', '5d10', '6s2', '6p1' ], 81, 'Thallium' ),
    ...
    'Fr': ( 'Rn', [ '7s11' ], 87, 'Francium' ),
    'Ra': ( 'Rn', [ '7s2' ], 88, 'Radium' ),
    'Ac': ( 'Rn', [ '6d1', '7s2' ], 89, 'Actinium' ),
...
import os
import sys
with open("/Users/kurataiori/Master/QEtools/sssp_efficiency.json", "r") as f:
    sssp = json.load(f)
...
element_dict = {}
for ele in sssp:
    cutoff = sssp[ele]["cutoff"]
    dual = sssp[ele]["dual"]
    filename = sssp[ele]["filename"]
    config = atomic_configs_dict[ele][1]
    if atomic_configs_dict[ele][2] :
        
    SOC = 
    U = 
    element_dict[ele] = {"config":config, "SOC": ,"U": ,"filename": filename, "cutoff": "cutoff", "dual": dual}
